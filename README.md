...
- ✅ FHEVM SDK integrated with React hooks (`useFhevmContext`, `useEncrypt`)
- ✅ Beautiful Tailwind CSS UI with responsive design
- ✅ Real-time encryption/decryption with loading states
- ✅ Wallet integration (MetaMask, WalletConnect compatible)
- ✅ Trading period management system
- ✅ Confidential energy offers and demands
- ✅ API routes for server-side FHE operations
- ✅ Multiple demo examples (Banking, Medical Records)
...
# Edit .env.local with NEXT_PUBLIC_CONTRACT_ADDRESS
npm run dev
...
<FhevmProvider config={{ network: 'sepolia', contractAddress: CONTRACT_ADDRESS }}>
  <App />
</FhevmProvider>

// 2. Using Hooks in Components (src/components/EnergyOfferForm.tsx)
import { useFhevmContext, useEncrypt } from '@fhevm/sdk/react';

const { client, isReady } = useFhevmContext();
const { encrypt, isEncrypting } = useEncrypt(client);

// Encrypt values before sending to contract
const encryptedAmount = await encrypt(1000, { bits: 32 });
const encryptedPrice = await encrypt(50, { bits: 32 });

// 3. Status Monitoring (src/components/SDKStatus.tsx)
...
│   │   ├── demos/page.tsx        # Additional examples
│   │   └── api/                  # Server-side FHE endpoints
│   │       ├── fhe/encrypt/      # Encryption API
│   │       ├── fhe/decrypt/      # Decryption API
│   │       └── fhe/compute/      # Computation API
│   ├── components/
│   │   ├── EnergyOfferForm.tsx   # Offer submission with SDK
│   │   ├── EnergyDemandForm.tsx  # Demand submission with SDK
│   │   ├── SDKStatus.tsx         # Real-time SDK status
...
│   ├── hooks/
│   │   ├── useEncryption.ts      # Custom encryption hook
│   │   └── useComputation.ts     # FHE computation hook
│   └── lib/
...
### 2. React + Vite Energy Market Application

**Location**: `examples/private-energy-market-react/`

A **modern React application built with Vite** demonstrating FHEVM SDK integration in a single-page application. This example shows how to use the SDK in a pure React environment without Next.js.

**Features**:
- ✅ React 18 with TypeScript and Vite
- ✅ FHEVM SDK integrated with custom hooks
- ✅ Clean component architecture
- ✅ Wallet integration (MetaMask)
- ✅ Real-time encryption/decryption
- ✅ Confidential energy trading interface
- ✅ Fast development with Vite HMR
- ✅ Production-ready build configuration

**Quick Start**:
```bash
cd examples/private-energy-market-react
npm install
cp .env.example .env.local
# Edit .env.local with VITE_CONTRACT_ADDRESS
npm run dev
...
**SDK Integration**:
```tsx
// App.tsx - Initialize FHEVM client
import { createFhevmClient, encrypt } from '@fhevm/sdk'
...
// Components - Use SDK for encryption
...
### 3. Smart Contract with Node.js Integration
...
**Features**:
- ✅ Production-ready smart contracts with FHEVM encryption
- ✅ 45+ comprehensive test cases with full coverage
- ✅ SDK-integrated deployment and interaction scripts
- ✅ Automated testing and gas analysis
- ✅ Etherscan verification support
- ✅ Complete development environment setup
- ✅ Example scripts showing SDK usage patterns
...
```javascript
// scripts/interact-with-sdk.js
const { createFhevmClient, encrypt32 } = require('@fhevm/sdk');

// Initialize SDK for backend use
const client = await createFhevmClient({
  network: 'sepolia',
  contractAddress: CONTRACT_ADDRESS,
...
// Encrypt values before contract interaction
const encryptedAmount = await encrypt32(client, 1000);
...
│   ├── interact.js               # Basic interaction
│   └── interact-with-sdk.js      # SDK integration example
├── test/
│   └── PrivateRenewableEnergyMarket.test.js
├── hardhat.config.js
└── README.md
```
...
│   │   │   ├── demos/                 # Additional demo pages
│   │   │   └── api/                   # Server-side API routes
│   │   │       └── fhe/               # FHE operations
│   │   ├── components/                # React components with SDK
│   │   │   ├── EnergyOfferForm.tsx    # Uses useEncrypt hook
│   │   │   ├── EnergyDemandForm.tsx   # Uses useEncrypt hook
│   │   │   ├── SDKStatus.tsx          # Uses useFhevmContext
│   │   │   ├── fhe/                   # FHE demos
...
│   └── package.json                   # Dependencies
│
├── private-energy-market-react/       # React + Vite example
│   ├── src/
│   │   ├── components/                # React components
│   │   │   ├── WalletConnect.tsx      # Wallet integration
│   │   │   ├── TradingPeriodInfo.tsx  # Trading period
│   │   │   ├── EnergyOfferForm.tsx    # Offer form with SDK
│   │   │   └── EnergyDemandForm.tsx   # Demand form with SDK
...
└── renewable-energy-market/           # Smart contract example
    ...
    │   ├── interact.js                # Basic interaction
    │   └── interact-with-sdk.js       # SDK integration demo
...
│   │   │   │   ├── EnergyOfferForm.tsx     # Offer form (uses SDK)
│   │   │   │   ├── EnergyDemandForm.tsx    # Demand form (uses SDK)
│   │   │   │   ├── TradingPeriodInfo.tsx   # Trading period display
│   │   │   │   ├── fhe/                    # FHE-specific demos
│   │   │   │   │   ├── EncryptionDemo.tsx  # Encryption examples
│   │   │   │   │   ├── ComputationDemo.tsx # Computation examples
...
│   │   ├── ADVANCED_README.md              # Advanced topics
